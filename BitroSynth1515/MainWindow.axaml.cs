...
public partial class MainWindow : Window
{
    ...
    private async Task InitAsync()
    {
        ...
        if (!SharedResources.EngineFileExists(SharedResources.BaseEngine.RustPlaybackEngine))
        {
        ...
        {
            // To make menu items easy to read in Linux.
            openMenuItem.Background = Brushes.Black;
            saveAsMenuItem.Background = Brushes.Black;
            exportAudioMenuItem.Background = Brushes.Black;
            noteWithGUIMenuItem.Background = Brushes.Black;
            aboutMenuItem.Background = Brushes.Black;

            aboutMenuItem.Foreground = Brushes.White;
            openMenuItem.Foreground = Brushes.White;
            saveAsMenuItem.Foreground = Brushes.White;
            exportAudioMenuItem.Foreground = Brushes.White;
            noteWithGUIMenuItem.Foreground = Brushes.White;
